...
organization := "scalasnippets"

version := "0.1.0-SNAPSHOT"

description := "just some random stuff"

homepage := Some(url("https://github.com/tom-muhm/scala-snippets"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/tom-muhm/scala-snippets"),
    "scm:git:https://github.com/tom-muhm/scala-snippets.git",
    Some("scm:git:git@github.com:tom-muhm/scala-snippets.git")
  )
)
